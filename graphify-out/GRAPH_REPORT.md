# Graph Report - web-interactive-dsa-handbook  (2026-06-28)

## Corpus Check
- 142 files · ~337,193 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 856 nodes · 1091 edges · 90 communities (65 shown, 25 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `81ff57b1`
...
7. `BRIEFING — 2026-06-28T20:52:40+07:00` - 12 edges
8. `makeFrame()` - 11 edges
...
- `HashTableWorkspace()` --calls--> `usePlaybackKeyboard()`  [EXTRACTED]
  src/features/hash-table/components/HashTableWorkspace.tsx → src/shared/hooks/usePlaybackKeyboard.ts
- `LinkedListVisualizerProps` --references--> `NodeItem`  [EXTRACTED]
  src/features/linked-list/components/LinkedListVisualizer.tsx → src/shared/types/index.ts
...
Cohesion: 0.18
Nodes (6): SortingArrayEditor(), SortingArrayEditorProps, SortingWorkspace(), PlaybackControls(), PlaybackControlsProps, SHORTCUTS

### Community 1 - "Community 1"
Cohesion: 0.08
Nodes (31): InsertPosition, LinkedListVisualizer(), LinkedListVisualizerProps, SortingVisualizer(), SortingVisualizerProps, STATUS_STYLE, SortingWorkspaceProps, SortingSection() (+23 more)
...
Cohesion: 0.06
Nodes (32): App(), GraphPage, HashTablePage, HomePage, LinkedListPage, NotFoundPage, PracticePage, router (+24 more)
...
Cohesion: 0.15
Nodes (12): Active Timers, Artifact Index, BRIEFING — 2026-06-28T20:52:40+07:00, Current Parent, Current Parent, 🔒 Key Constraints, Key Decisions Made, Mission (+4 more)
...
Cohesion: 0.40
Nodes (4): Architecture, Interface Contracts, Milestones, Project: Web Interactive DSA Handbook
...
Cohesion: 0.20
Nodes (9): BINARY_SEARCH_CODE, CodeViewer(), CodeViewerProps, LINEAR_SEARCH_CODE, LINKED_LIST_CODE, SEARCH_ARRAY, SearchFrame, SearchVisualizer() (+1 more)

### Community 78 - "Community 78"
Cohesion: 0.24
Nodes (7): AlgoId, GraphWorkspace(), Options, PlaybackHandle, usePlaybackKeyboard(), BFS_CODE, DFS_CODE
...
## Knowledge Gaps
- **419 isolated node(s):** `consoleErrors`, `pageErrors`, `name`, `private`, `version` (+414 more)
...
- **Why does `usePlaybackKeyboard()` connect `Community 78` to `Community 0`, `Community 69`, `Community 70`, `Community 6`, `Community 72`, `Community 77`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `usePlayback()` connect `Community 70` to `Community 0`, `Community 69`, `Community 6`, `Community 72`, `Community 77`, `Community 78`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `CodeViewer()` connect `Community 77` to `Community 0`, `Community 69`, `Community 70`, `Community 6`, `Community 72`, `Community 13`, `Community 78`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
