...
export default function PracticeSection({ activeLesson }: PracticeSectionProps) {
  ...
  const handleRunCode = () => {
    ...
    // Create the inline Web Worker code
    const workerCode = `
      try {
        self.eval = undefined;
      } catch (e) {}
        ...
        try {
          ...
          for (const tc of testCases) {
            ...
            try {
              ...
              // Prevent circular structure and serialization errors by checking stringify
